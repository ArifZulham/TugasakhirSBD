    ...
    <tbody>
        @foreach ($datas as $data)
            <tr>
                ...
                <td>{{ $data->kode_pos }}</td>
                <td>
                    <a href="{{ route('sekolah.restore', $data->id_sekolah) }}" type="button" class="btn btn-info rounded-3">Restore</a>
                    ...
                    <div class="modal fade" id="hapusModal{{ $data->id_sekolah }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('sekolah.delete', $data->id_sekolah) }}">
                                    @csrf
